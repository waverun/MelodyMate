...
class ImageBrightness {
    ...
    static func getImageBrightness(of image : UIImage) -> CGFloat {
        var red: CGFloat = 0
        var green: CGFloat = 0
        var blue: CGFloat = 0
        var alpha: CGFloat = 0
    ...
    static func isDarkColor(of image : UIImage) -> Bool {
        return getImageBrightness(of: image) < 0.5
    }

    static func avoidBlackBackground(of image: UIImage) -> Bool {
